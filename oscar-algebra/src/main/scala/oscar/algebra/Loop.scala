...
class LoopSystem[T <: AnyType](val loops: Stream[ALoop[_,Equation[T]]], val name: String = "System") extends System[T]{
...
case class Indices[T](name: String, values: IndexedSeq[T])(implicit model: Model[_,_]) /*extends ALoop[T,T]*/ {
