...
import oscar.cbls.business.routing.invariants.WeigthedNodesPerVehicle
...
class VRPTWWithWeightedNodes(n: Int, v: Int, minLat: Double, maxLat: Double, minLong: Double, maxLong: Double) {
  ...
  val weightedNodesConstraint = WeigthedNodesPerVehicle(myVRP.routes, v, nodeWeight, weightPerVehicle)
