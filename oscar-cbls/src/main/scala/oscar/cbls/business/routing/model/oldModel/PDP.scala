...
import oscar.cbls.business.routing.model.TravelTimeFunction
...
class PDP(override val n:Int,
  ...
  /**
    ...
    * It runs through the specified route and create all the complete segment of this route
    *
    * @param routeNumber the number of the route
    * @return the list of all the complete segment present in the route represented by a tuple (startingNode, endingNode)
    */
