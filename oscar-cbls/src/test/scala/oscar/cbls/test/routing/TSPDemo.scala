...
class MySimpleRoutingWithUnroutedPoints(n:Int,v:Int,symmetricDistance:Array[Array[Int]],pointsPositions:Array[(Int,Int)],m:Store, maxPivot:Int)
...
object TSPDemo extends App {
  ...
  new TSPRoutePointsS(1000,1,4,verbose)
  System.gc()
...
class TSPDemo(n:Int,v:Int,maxPivotPerValuePercent:Int, verbose:Int) extends StopWatch{
  ...
  val myVRP = new MySimpleRoutingWithUnroutedPoints(n,v,symmetricDistanceMatrix,pointsPositions,model,maxPivotPerValuePercent)
