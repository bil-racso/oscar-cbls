...
/*
add(startVars(0)(0) == 0)
add(startVars(0)(1) == 70)
add(startVars(0)(2) == 90)
add(startVars(0)(3) == 370)
add(startVars(0)(4) == 530)
add(startVars(0)(5) == 550)
add(startVars(0)(6) == 850)
add(startVars(0)(7) == 920)
add(startVars(1)(0) == 0)
add(startVars(1)(1) == 140)
add(startVars(1)(2) == 240)
add(startVars(1)(3) == 530)
add(startVars(1)(4) == 610)
add(startVars(1)(5) == 690)
add(startVars(1)(6) == 770)
add(startVars(1)(7) == 920)
add(startVars(2)(0) == 0)
add(startVars(2)(1) == 140)
add(startVars(2)(2) == 160)
add(startVars(2)(3) == 300)
add(startVars(2)(4) == 370)
add(startVars(2)(5) == 390)
add(startVars(2)(6) == 690)
add(startVars(2)(7) == 920)
add(startVars(3)(0) == 0)
add(startVars(3)(1) == 70)
add(startVars(3)(2) == 170)
add(startVars(3)(3) == 370)
add(startVars(3)(4) == 450)
add(startVars(3)(5) == 470)
add(startVars(3)(6) == 610)
add(startVars(3)(7) == 920)
add(startVars(4)(0) == 0)
add(startVars(4)(1) == 220)
add(startVars(4)(2) == 240)
add(startVars(4)(3) == 450)
add(startVars(4)(4) == 530)
add(startVars(4)(5) == 610)
add(startVars(4)(6) == 850)
add(startVars(4)(7) == 920)
add(startVars(5)(0) == 0)
add(startVars(5)(1) == 140)
add(startVars(5)(2) == 360)
add(startVars(5)(3) == 530)
add(startVars(5)(4) == 610)
add(startVars(5)(5) == 630)
add(startVars(5)(6) == 770)
add(startVars(5)(7) == 920)
*/
  //add(makespan <= 940)
  ...
  minimize(makespan) search {
    ...
    //setTimes(startVarsFlat, durationVarsFlat, endVarsFlat,i => -startVarsFlat(i).min)
    //binaryStatic(startVarsFlat, _.min)
