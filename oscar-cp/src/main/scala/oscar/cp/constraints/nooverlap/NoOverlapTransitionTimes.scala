...
class NoOverlapTransitionTimes(starts: Array[CPIntVar], durations: Array[CPIntVar], ends: Array[CPIntVar], transitionMatrix: Array[Array[Int]], runOnResource: Array[CPIntVar], resourceId : Int) extends NoOverlap(starts, durations, ends, runOnResource, resourceId) {
