...
object FactoryModelExample extends App with AttributeHelper with ListenersHelper with implicitConvertors{
  ...
  val rawMaterialStorage = fm.fIFOStorage(200,List((40,AttributeSet(SortedSet(initialRawBatch),allAttributes).itemClass)),"rawMaterialStorage",false,"0",allAttributes)
  ...
  val inputFeederOfDieCuttingPartA = fm.fIFOStorage(100,Nil,"inputFeederOfDieCuttingPartA",false,"0",allAttributes)
  ...
  val outputSlotOfDieCuttingPArtA = fm.lIFOStorage(400,Nil,"outputSlotOfDieCuttingPArtA",false,"0",allAttributes)
  ...
  val outputOfQAAfterCutting = fm.fIFOStorage(100,Nil,"inputFeederOfDieCuttingPartA",false,"0",allAttributes)
  val trashContainerForRejectedCutItems = fm.lIFOStorage(1000000000, Nil, "trashContainerForRejectedCutItems", false,"0",allAttributes)
  ...
  val bufferForDieA =  fm.fIFOStorage(500,Nil,"bufferForDieA",false,"0",allAttributes)
  ...
  val inputAOfForming = fm.fIFOStorage(2, Nil, "inputAOfForming", false,"0",allAttributes)
  ...
  //we consider here individual "already cut" dies although they are still aggregated into a single coil
  val inputFeederOfDieCuttingPartB = fm.fIFOStorage(100, Nil, "inputFeederOfDieCuttingPartB", false,"0",allAttributes)
  ...
  val outputSlotOfDieCuttingPArtB = fm.lIFOStorage(4, Nil, "outputSlotOfDieCuttingPArtB", true,"0",allAttributes)
  ...
  val bufferForDieB = fm.lIFOStorage(500, Nil, "outputSlotOfDieCuttingPArtA", false,"0",allAttributes)
  ...
  val inputBOfForming = fm.lIFOStorage(2, Nil, "inputBOfForming", false,"0",allAttributes)
  ...
  val outputContainerOfForming = fm.lIFOStorage(120, Nil, "outputContainerOfForming",false,"0",allAttributes)
  ...
  val formedContainerStoragePlace = fm.lIFOStorage(1000000000, Nil, "containerStoragePlace", false,"0",allAttributes)
  val trashContainerStoragePlace = fm.lIFOStorage(1000000000, Nil, "TrashContainerStoragePlace", false,"0",allAttributes)
