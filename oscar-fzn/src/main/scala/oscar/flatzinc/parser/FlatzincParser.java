...
public class FlatzincParser extends Parser {
	...
	public final PredparamContext predparam() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(96); predparamtype();
			setState(97); match(T__18);
			setState(98); predannid();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ParamdeclContext paramdecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(100); ((ParamdeclContext)_localctx).partype = partype();
			setState(101); match(T__18);
			setState(102); ((ParamdeclContext)_localctx).varparid = varparid();
			setState(103); match(T__5);
			setState(104); ((ParamdeclContext)_localctx).expr = expr();
	...
	public final VardeclContext vardecl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(108); ((VardeclContext)_localctx).vartype = vartype();
			setState(109); match(T__18);
			setState(110); ((VardeclContext)_localctx).varparid = varparid();
			setState(111); ((VardeclContext)_localctx).annotations = annotations();
			setState(116);
			_la = _input.LA(1);
			if (_la==T__5) {
				{
				setState(112); match(T__5);
				setState(113); ((VardeclContext)_localctx).expr = expr();
	...
	public final ConstraintContext constraint() throws RecognitionException {
		...
		try {
			...
			setState(122); ((ConstraintContext)_localctx).predannid = predannid();
			setState(123); match(T__19);
			setState(124); ((ConstraintContext)_localctx).e = expr();
			...
			while (_la==T__21) {
				...
				setState(127); ((ConstraintContext)_localctx).e1 = expr();
			...
			setState(136); ((ConstraintContext)_localctx).annotations = annotations();
	...
	public final SolvegoalContext solvegoal() throws RecognitionException {
		...
		try {
			...
			setState(141); ((SolvegoalContext)_localctx).annotations = annotations();
			setState(155);
			switch (_input.LA(1)) {
			case T__1:
				{
			...
			case T__23:
				...
				setState(146); ((SolvegoalContext)_localctx).expr = expr();
			...
			case T__3:
				...
				setState(151); ((SolvegoalContext)_localctx).expr = expr();
	...
	public final BasicvartypeContext basicvartype() throws RecognitionException {
		...
		try {
			...
			case INT:
				{
				setState(181); ((BasicvartypeContext)_localctx).setconst = setconst();
			...
			case T__14:
				...
				setState(185); match(T__22);
				setState(186); ((BasicvartypeContext)_localctx).setconst = setconst();
	...
	public final PartypeContext partype() throws RecognitionException {
		...
		try {
			...
			case T__9:
				enterOuterAlt(_localctx, 1);
				{
				setState(191); ((PartypeContext)_localctx).basicpartype = basicpartype();
			...
			case T__16:
				enterOuterAlt(_localctx, 2);
				{
				setState(194); ((PartypeContext)_localctx).arraytype = arraytype();
				setState(195); ((PartypeContext)_localctx).basicpartype = basicpartype();
	...
	public final VartypeContext vartype() throws RecognitionException {
		...
		try {
			...
			case T__15:
				enterOuterAlt(_localctx, 1);
				{
				setState(200); ((VartypeContext)_localctx).basicvartype = basicvartype();
			...
			case T__16:
				enterOuterAlt(_localctx, 2);
				{
				setState(203); ((VartypeContext)_localctx).arraytype = arraytype();
				setState(204); ((VartypeContext)_localctx).basicvartype = basicvartype();
	...
	public final ArraytypeContext arraytype() throws RecognitionException {
		...
		try {
			...
			setState(211); ((ArraytypeContext)_localctx).lb = intconst();
			setState(212); match(T__0);
			setState(213); ((ArraytypeContext)_localctx).ub = intconst();
	...
	public final PredparamtypeContext predparamtype() throws RecognitionException {
		...
		try {
			...
			case INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(218); ((PredparamtypeContext)_localctx).basicpredparamtype = basicpredparamtype();
			...
			case T__16:
				enterOuterAlt(_localctx, 2);
				{
				setState(221); ((PredparamtypeContext)_localctx).predarraytype = predarraytype();
				setState(222); ((PredparamtypeContext)_localctx).basicpredparamtype = basicpredparamtype();
	...
	public final BasicpredparamtypeContext basicpredparamtype() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(227); ((BasicpredparamtypeContext)_localctx).basicvartype = basicvartype();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(230); ((BasicpredparamtypeContext)_localctx).basicpartype = basicpartype();
	...
	public final PredarraytypeContext predarraytype() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(255); ((PredarraytypeContext)_localctx).lb = intconst();
				setState(256); match(T__0);
				setState(257); ((PredarraytypeContext)_localctx).ub = intconst();
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case Boolconst:
				enterOuterAlt(_localctx, 1);
				{
				setState(271); ((ExprContext)_localctx).boolconst = boolconst();
			...
			case Floatconst:
				enterOuterAlt(_localctx, 2);
				{
				setState(274); ((ExprContext)_localctx).floatconst = floatconst();
			...
			case INT:
				enterOuterAlt(_localctx, 3);
				{
				setState(277); ((ExprContext)_localctx).intorsetconst = intorsetconst();
			...
			case VARPARID:
				enterOuterAlt(_localctx, 4);
				{
				setState(280); ((ExprContext)_localctx).idorannot = idorannot();
			...
			case T__20:
				enterOuterAlt(_localctx, 5);
				{
				setState(283); ((ExprContext)_localctx).arrayexpr = arrayexpr();
			...
			case STRING:
				enterOuterAlt(_localctx, 6);
				{
				setState(286); ((ExprContext)_localctx).stringconstant = stringconstant();
	...
	public final IdorannotContext idorannot() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(291); ((IdorannotContext)_localctx).varparid = varparid();
			setState(313);
			switch (_input.LA(1)) {
			case T__24:
			case T__21:
			...
			case T__20:
				...
				setState(294); ((IdorannotContext)_localctx).intconst = intconst();
			...
			case T__19:
				...
				setState(300); ((IdorannotContext)_localctx).expr = expr();
				...
				while (_la==T__21) {
					...
					setState(303); ((IdorannotContext)_localctx).expr = expr();
					(_localctx.ann).add(((IdorannotContext)_localctx).expr.e);
					}
					}
					setState(310);
	...
	public final IntorsetconstContext intorsetconst() throws RecognitionException {
		...
		try {
			...
			case INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(315); ((IntorsetconstContext)_localctx).lb = ((IntorsetconstContext)_localctx).intconst = intconst();
				setState(321);
				switch (_input.LA(1)) {
				case T__24:
				case T__21:
				...
				case T__0:
					...
					setState(318); ((IntorsetconstContext)_localctx).ub = ((IntorsetconstContext)_localctx).intconst = intconst();
			...
			case T__13:
				...
				if (_la==INT) {
					{
					setState(325); ((IntorsetconstContext)_localctx).f = intconst();
					...
					while (_la==T__21) {
						...
						setState(328); ((IntorsetconstContext)_localctx).n = intconst();
	...
	public final SetconstContext setconst() throws RecognitionException {
		...
		try {
			...
			case INT:
				enterOuterAlt(_localctx, 1);
				{
				setState(342); ((SetconstContext)_localctx).lb = intconst();
				setState(343); match(T__0);
				setState(344); ((SetconstContext)_localctx).ub = intconst();
			...
			case T__13:
				...
				if (_la==INT) {
					{
					setState(349); ((SetconstContext)_localctx).f = intconst();
					...
					while (_la==T__21) {
						...
						setState(352); ((SetconstContext)_localctx).n = intconst();
	...
	public final ArrayexprContext arrayexpr() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__20) | (1L << T__13) | (1L << Boolconst) | (1L << PREDANNID) | (1L << VARPARID) | (1L << Floatconst) | (1L << INT) | (1L << STRING))) != 0)) {
				{
				setState(368); ((ArrayexprContext)_localctx).e = expr();
				...
				while (_la==T__21) {
					{
					{
					setState(370); match(T__21);
					setState(371); ((ArrayexprContext)_localctx).e = expr();
					_localctx.a.elements.add(((ArrayexprContext)_localctx).e.e); _localctx.a.typ.size+=1; if(((ArrayexprContext)_localctx).e.e.typ.isVar)_localctx.a.typ.isVar = true; 
					}
					}
					setState(378);
	...
	public final AnnotationsContext annotations() throws RecognitionException {
		...
		try {
			...
			while (_la==T__7) {
				...
				setState(386); ((AnnotationsContext)_localctx).annotation = annotation();
	...
	public final AnnotationContext annotation() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(394); ((AnnotationContext)_localctx).predannid = predannid();
			...
			if (_la==T__19) {
				...
				setState(397); ((AnnotationContext)_localctx).expr = expr();
				...
				while (_la==T__21) {
					{
					{
					setState(399); match(T__21);
					setState(400); ((AnnotationContext)_localctx).expr = expr();
					(_localctx.ann).add(((AnnotationContext)_localctx).expr.e);
					}
					}
					setState(407);
	...
	public final PredannidContext predannid() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(412); ((PredannidContext)_localctx).PREDANNID = match(PREDANNID);
	...
	public final BoolconstContext boolconst() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(415); ((BoolconstContext)_localctx).Boolconst = match(Boolconst);
	...
	public final FloatconstContext floatconst() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(418); ((FloatconstContext)_localctx).Floatconst = match(Floatconst);
	...
	public final IntconstContext intconst() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(421); ((IntconstContext)_localctx).INT = match(INT);
	...
	public final StringconstantContext stringconstant() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(424); ((StringconstantContext)_localctx).STRING = match(STRING);
	...
	public final VarparidContext varparid() throws RecognitionException {
		...
		try {
			...
			case VARPARID:
				enterOuterAlt(_localctx, 1);
				{
				setState(427); ((VarparidContext)_localctx).VARPARID = match(VARPARID);
			...
			case PREDANNID:
				enterOuterAlt(_localctx, 2);
				{
				setState(429); ((VarparidContext)_localctx).PREDANNID = match(PREDANNID);
	...
	public static final String _serializedATN =
		...
		"\2\2TU\7\21\2\2UV\7\35\2\2VW\7\b\2\2W\\\5\6\4\2XY\7\6\2\2Y[\5\6\4\2ZX"+
		"\3\2\2\2[^\3\2\2\2\\Z\3\2\2\2\\]\3\2\2\2]_\3\2\2\2^\\\3\2\2\2_`\7\23\2"+
		"\2`a\7\27\2\2a\5\3\2\2\2bc\5\32\16\2cd\7\t\2\2de\5.\30\2e\7\3\2\2\2fg"+
		"\5\24\13\2gh\7\t\2\2hi\58\35\2ij\7\26\2\2jk\5 \21\2kl\7\27\2\2lm\b\5\1"+
		"\2m\t\3\2\2\2no\5\26\f\2op\7\t\2\2pq\58\35\2qv\5*\26\2rs\7\26\2\2st\5"+
		" \21\2tu\b\6\1\2uw\3\2\2\2vr\3\2\2\2vw\3\2\2\2wx\3\2\2\2xy\7\27\2\2yz"+
		"\b\6\1\2z\13\3\2\2\2{|\7\25\2\2|}\5.\30\2}~\7\b\2\2~\177\5 \21\2\177\u0086"+
