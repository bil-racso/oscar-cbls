 ...
 * a > b
 */
case class GrFloat(a: FloatExpression, b: FloatExpression) extends BoolExpression {
  /**
   ...
   */
  override def mapSubexpressions(func: (Expression) => Expression): BoolExpression = GrFloat(func(a).asInstanceOf[FloatExpression],func(b).asInstanceOf[FloatExpression])
